...
export const adData: Ad[] = [
    { url: "https://meidaisai.jp", src: "/images/ad/adachi.jpg", id: "adachi" },//足立自動車学校
    { url: "https://meidaisai.jp", src: "/images/ad/towa.jpg", id: "towa" },//東和エンジニアリング
    ...
    { url: "https://meidaisai.jp", src: "/images/ad/ichikura.jpg", id: "ichikura" },//株式会社一蔵
    ...
    { url: "https://meidaisai.jp", src: "/images/ad/matsubara.png", id: "matsubara" },//松原皮膚科
...
export const smallAdData: Ad[] = [
    ...
    { url: "https://meidaisai.jp", src: "/images/ad/suruga.jpg", id: "suruga" },//駿河台学園
];