    ...
    return (
        <CloudPageContainer>
            ...
            <ImageText src="/images/donation/donation.png" alt="明大祭・募金企画" >
                日頃より、明大祭への応援・ご協力ありがとうございます。<br />
                この度、9月21日(月・祝)から11月9日(月)の期間で、第142回明大祭への募金企画を行います。この取り組みは明治大学と連携した期間限定募金という初の試みとなります。
                {/* 学生の思いがこもった当企画のサイトを、ぜひ一度ご覧ください！ */}
                {/* サイトURLを入れる */}
            </ImageText>
            ...
            <Text moreTopPadding>目標金額は<Emphasis bold>「60万円」</Emphasis>です。</Text>
