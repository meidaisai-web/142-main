...
//             date: "11月3日(月・祝)",
//             content: "「わかさぽ」では、看護師等が若者のからだやこころの悩みにお答えしています。わかさぽの紹介のほか、ユースヘルスケアに関するクイズに挑戦した方へお菓子・ノベルティをプレゼント！イベント限定動画も公開！"
//         }
//     ]
//     return (
//         <div>
...
export default function Page() {
    return (
        <div>
            ...
            <PageContainer>
                <p className="text-center mt-10">企業ブースの詳細は後日公開予定です。お楽しみに！</p>
            </PageContainer>
        </div>
    )
}