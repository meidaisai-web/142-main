...
export default function Page() {
    const data = [
        ...
        },
        {
            ...
            content: "wiccaの腕時計で盛れる♡韓国っぽ本格セルフ写真が撮れるブース！ 生年月日に合わせた「生まれて○○秒」の限定ステッカーもプレゼント♪友達との記念にも♡ぴったり！"
        },
        {
            ...
            <PageContainer>
                ...
                {data.map((item) => (
                    <div key={item.name} className="mb-5 lg:text-lg">
                        ...
                        <OnlyImage src={item.image} alt={item.name} className="w-[90vw] h-[30vh] md:w-[50vw]"/>
