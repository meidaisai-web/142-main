  ...
  return (
    <div>
      ...
      <PageContainer>
        ...
        <SmallTitle>第141回明大祭実行委員会 委員長</SmallTitle>
        <ImageText src="/images/Mariko.png" alt="第141回明大祭委員会委員長 鞠子 輝">
          ...
          <Text moreTopPadding className="hidden xl:block">
            その想いを形にする原動力は、学生一人ひとりの主体的な挑戦です。ステージで声を響かせる者、模擬店で汗を流す者、研究の成果を伝える者、すべてが学生の力によって成り立っています。そしてその力は、大学という場があり、地域のみなさまに見守られ、来場してくださる一人ひとりがいて初めて輝きを増すのです。学生、大学、地域、来場者が繋がり合い、互いに響き合うとき、明大祭はただの祭ではなく、特別な価値を持つ場へと昇華します。
          </Text>
        </ImageText>
        <Text moreTopPadding className="xl:hidden">
