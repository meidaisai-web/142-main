  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className="mt-15 mx-30">
          <Text>
            このたびは第141回明大祭にご来場いただき、誠にありがとうございます。明大祭は、長い歴史のなかで先輩方から受け継がれてきた学生の情熱と努力の結晶です。その想いが脈々と紡がれてきたからこそ、今、私たちはこの場に立ち、みなさまと共に祭を創り上げることができています。
          </Text>
          <Text className="mt-5">
          ...
          <Text className="mt-5 !text-right">第141回明大祭実行委員会<br/>委員長  鞠子 輝</Text> 
        </div>
      </div>
      ...
      <div className="flex justify-center mt-15 mx-10">
        <Movie href="https://www.youtube.com/embed/yZS7Xf1UkoU?si=SwkrXZW3y2kq9v5o" />
      </div>
    </div>
  )
}