...
//                     引き換えボタンは、<Emphasis>総合インフォメーションブースで引き換える時にタップしてください</Emphasis>。事前にタップしてしまうと抽選券と引き換えることができなくなります。</ListItem>
...
export default function Page() {
    return(
        <div>
            <PageTitle>明大祭大抽選会 抽選券引き換え画面</PageTitle>
            <PageContainer>
                <p className="text-center mt-10">明大祭大抽選会 抽選券引き換え画面の詳細は後日公開予定です。お楽しみに！</p>
            </PageContainer>
        </div>
    )
}