    ...
    return (
        <div>
            ...
            <PageContainer>
                ...
                <ImageText src="/images/area/summerfesta.jpg" alt="SummerFestival Image">明大前駅前広場において昨年度の8月24日(土)、25日(日)に開催された明大前サマーフェスタ＆盆踊りにお手伝いとして参加させていただきました。明大前商店街振興組合の方々のご指導のもと、模擬店やステージでのパフォーマンスに関しまして微力ながら尽力いたしました。</ImageText>
                ...
                <ImageText src="/images/area/nakanofes.jpg" alt="NakanoFes Image">中野キャンパス竣工以来、中野チャンプルーフェスタにお手伝いとして参加させていただいております。7月19日(土)、20日(日)に開催された｢中野チャンプルーフェスタ2025｣にお手伝いとして参加させていただきました。模擬店出店や動線管理など、イベントの盛況に微力ながら尽力いたしました。</ImageText>
                <SmallTitle>下北沢周辺地域での取り組み</SmallTitle>
                <AccentText>下北沢盆踊り</AccentText>
                <ImageText src="/images/area/shimokita.jpg" alt="shimokita Image">下北沢において、8月9日(土)、10日(日)に開催された下北沢盆踊りに参加させていただきました。ボランティアとして地域の輪に入り、イベントの盛況に微力ながら尽力いたしました。</ImageText>
