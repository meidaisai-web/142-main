...
return (
	<div>
		...
		<PageContainer>
            ...
            <div className="mt-6">
            <Text>第141回明大祭公式サイトをご覧いただきありがとうございます。</Text>
            <Text>この度、第141回明大祭を11月1日(土).2日(日).3日(月・祝)に明治大学和泉キャンパスにて開催することが決定いたしました。</Text>
            <div className="m-4 -translate-x-4">
            <Text>界隈地域のみなさまにおかれましては、第140回明大祭開催にご理解・ご協力をいただき誠にありがとうございました。昨年度の活動では、多くの場面で界隈地域のみなさまとの関わりが明大祭開催において大切であることを改めて感じました。明大生は界隈地域のみなさまの支えがあってこそ充実した学生生活を送ることができております。</Text>
            </div>
            <Text>明大祭実行委員一同、界隈地域のみなさまに心より感謝を申し上げるとともに、みなさまのご期待にお応えできるよう明大祭実行委員会として地域イベントへの参加や清掃活動など、今年度からの新たな取り組みも含め、より広く、深く地域に貢献してまいります。そして、明大生主体の祭である明大祭を通して、日ごろの感謝を形として表現させていただきますので、ぜひご来場ください。</Text>
		    </div>
            <div className="mb-4">
            ...
            <Text>明大前駅前広場において昨年度の5月25日(土)、26日(日)に開催された明大前音楽祭にお手伝いとして参加させていただきました。
            ...
            <Text>駿河台キャンパス周辺地域において、昨年度の5月25日(土)に実施された神田すずらんまつりに参加させていただきました。
                地域と密接したイベントの盛況に、ボランティアとして微力ながら尽力いたしました。</Text>
            </div>
            <div className="mb-4">
            <AccentText>神保町ブックフェスティバル</AccentText>
            <Text>駿河台キャンパス周辺地域において、昨年度の10月26日(土)、27日(日)に実施された神保町ブックフェスティバルに参加させていただきました。
            ...
            <ImageText src="/images/ad/Nakanofes.jpg" alt="NakanoFes Image">中野キャンパス竣工以来、中野チャンプルーフェスタにお手伝いとして参加させていただいております。昨年度も7月13日(土)、14日(日)に開催された｢中野チャンプルーフェスタ2024｣にお手伝いとして参加させていただきました。模擬店出店や動線管理など、イベントの盛況に微力ながら尽力いたしました。</ImageText>
            <SectionTitle>お問い合わせ情報</SectionTitle>
