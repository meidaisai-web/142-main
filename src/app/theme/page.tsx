...
export default function Page() {
    return (
        <div>
            <PageTitle>第141回明大祭テーマ</PageTitle>
            <PageContainer>
                <p className="text-center mt-10">第141回明大祭テーマの詳細は後日公開予定です。お楽しみに！</p>
            </PageContainer>
        </div>
    )
}