    ...
    return (
        <div>
            ...
            <CloudPageContainer>
                ...
                <SmallTitle className="mt-15">応募方法</SmallTitle>
                ...
                <SmallTitle className="mt-15">応募期間</SmallTitle>
                <Text>9月17日(木)～10月16日(金)</Text>
                <SmallTitle className="mt-15">応募規約</SmallTitle>
                ...
                <Text className="mt-5">応募作品は、校内・明大祭での展示に適した内容のものに限ります。以下のような写真は展示対象外となる可能性があります。</Text>
                <List mark="・">
