        ...
        <div>
            ...
            <PageContainer>
                ...
                <ImageText src="/images/ad/crowdfunding.jpg" alt="明大祭の様子">
                    <Text moreTopPadding>日頃より、明大祭への応援・ご協力ありがとうございます。</Text>
                    <Text moreTopPadding>この度、10月1日(水)から11月9日(日)の期間で、第141回明大祭のクラウドファンディングが行われます。</Text>
                    <Text moreTopPadding>企画の立案からサイトの作成・実施まで、すべて学生が心を込めて行っております。</Text>
                    <Text moreTopPadding>現在、クラウドファンディングサイトは公開に向けて準備を進めております。公開まで今しばらくお待ちください。</Text>
                </ImageText>
                <SmallTitle>どんな天候でも明大生が最高に輝ける、熱狂的なステージを創りたい！</SmallTitle>
                <Text>様々なサークルや明大祭実行委員が一丸となり、1ヶ月以上の時間をかけて準備するステージ企画。</Text>
                <Text moreTopPadding>しかしその努力は虚しくも、第140回明大祭は悪天候に見舞われ、屋外ステージ企画の多くが中止となってしまいました。懸けてきたものの大きさから涙を流す学生もいました。</Text>
                ...
                <Text moreTopPadding>しかし、従来の仕様でもかなり資金を必要とするステージに、さらなる出費が嵩むこととなり、資金面での不安が出てきました。</Text>
                <Text moreTopPadding>そこで立ち上げられたのが、この「クラウドファンディング企画」です。</Text>
                <Text moreTopPadding>目標金額は<Emphasis>100万円</Emphasis>。</Text>
                <Text moreTopPadding>皆様からのご支援は、上記の内容のために大切に活用させていただきます。</Text>
                <Text moreTopPadding>また、支援していただいた方には、ささやかですが<Emphasis>返礼品もご用意しております</Emphasis>。</Text>
                {/* <List mark="※">
