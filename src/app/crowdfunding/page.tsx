        ...
        <div>
            ...
            <PageContainer>
                ...
                <ImageText src="/images/ad/crowdfunding.jpg" alt="明大祭の様子">
                    <Text>日頃より、明大祭への応援・ご協力ありがとうございます。</Text>
                    <Text moreTopPadding>この度、10月1日(水)から11月9日(日)の期間で、第141回明大祭のクラウドファンディングが行われます。<br />企画の立案からサイトの作成・実施まで、すべて学生が心を込めて行っております。<br />現在、クラウドファンディングサイトは公開に向けて準備を進めております。公開まで今しばらくお待ちください。</Text>
                </ImageText>
