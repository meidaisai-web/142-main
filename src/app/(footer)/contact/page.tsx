    ...
    return (
        <div>
            ...
            <PageContainer>
                ...
                <ContactView department="参加団体局" mail="141st-sankadantai@meidaisai.jp" noPadding />
                <SectionTitle>企業・校友・界隈地域のみなさまのお問い合わせ</SectionTitle>
                <ContactView department="渉外局" mail="shogai@meidaisai.jp" noPadding />
                <SectionTitle>メディアのみなさまのお問い合わせ</SectionTitle>
                <ContactView department="広報局" mail="141st-kouhou@meidaisai.jp" noPadding />
                <SectionTitle>その他第141回明大祭に関するお問い合わせ</SectionTitle>
                <ContactView department="" mail="141st4yaku@meidaisai.jp" noPadding />
            </PageContainer>
        </div>
    );
}