        ...
        <div>
            ...
            <PageContainer>
                ...
                <List numbered className="mt-10">
                    ...
                    <Text>当団体は、以下の目的の範囲内で個人情報を取り扱います。</Text>
                    <List mark="・">
                    ...
                    <Text>当団体は､運営や上記の目的に応じて消防署・保健所などの公的機関に個人情報を提供する場合があります｡ また､登録した個人情報を当団体の関連団体における関連業務の継承先に提供する場合があります｡その場合には､個人情報の保護が十分に図られることを条件とするなど適切な処置を行います｡</Text>
                    <ListItem>個人情報を取り扱うにあたり</ListItem>
                    <Text>当団体は､個人情報を適切に取り扱うために､個人情報の不正アクセスや個人情報の紛失､破壊､改ざんおよび漏洩防止に努めます｡</Text>
                    <ListItem>プライバシーポリシーについて</ListItem>
                    <Text>当団体は､個人情報の保護の強化などの理由からこのページの内容を変更する場合があります｡その際は当サイトのトップページ､お知らせページなどで公表いたします｡</Text>
                    <ListItem>IPアドレスの利用</ListItem>
                    <Text>当団体では､サーバーで発生した問題の突き止め､解決､およびサイト管理のために､ログに記録されたサイト利用者のIPアドレスを利用させていただくことがあります｡</Text>
                </List>
            </PageContainer>
        </div>
    )
