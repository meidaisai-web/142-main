...
export default function SectionTitle({ children}: SectionTitleProps) {
    return (
        <h2 className={'flex items-center justify-center gap-2 md:gap-4 text-xl sm:text-2xl md:text-4xl lg:text-5xl text-white px-4'}>
            <Image 
                ...
                aria-hidden 
            />
            <span className="whitespace-nowrap text-center dela-font">{children}</span>
            <Image 
